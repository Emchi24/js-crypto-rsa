...
test('encrypt, sign, decrypt, and verify works correctly', async () => {
  ...
  const [publicKeyTransmitter, privateKeyTransmitter] = await index.generateKeyPair(32)
  const [publicKeyRecipient, privateKeyRecipient] = await index.generateKeyPair(32)
